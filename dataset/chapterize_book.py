...
def cli(book, outdir, nochapters, stats, verbose, debug):
    ...
    bookObj = Book(book, outdir, nochapters, stats)

class Book():
    def __init__(self, filename, outdir, nochapters, stats):
    ...
    def writeChapters(self):
        ...
        noExt = os.path.join(self.outdir, os.path.splitext(basename)[0])
